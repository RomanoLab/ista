"""
Filter drug-disease adverse event mappings to only include entities that exist in neurokb
...
# Load the adverse event mappings
print("\nLoading drug_adverse_event_mappings.csv...")
df = pd.read_csv("drug_adverse_event_mappings.csv")
...
output_file = "drug_adverse_event_mappings_filtered.csv"
df_filtered.to_csv(output_file, index=False)
print(f"\nSaved filtered mappings to: {output_file}")

print("\nSummary:")
print(f"  Original: {len(df):,} adverse event mappings")
