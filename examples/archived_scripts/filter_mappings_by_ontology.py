"""
Filter drug-disease mappings to only include entities that exist in neurokb
...
# Load the mappings
print("\nLoading drug_disease_mappings.csv...")
df = pd.read_csv("drug_disease_mappings.csv")
...
output_file = "drug_disease_mappings_filtered.csv"
df_filtered.to_csv(output_file, index=False)
print(f"\nSaved filtered mappings to: {output_file}")

print("\nSummary:")
print(f"  Original: {len(df):,} mappings")
